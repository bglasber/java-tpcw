...
public class EBTPCW1Factory extends EBFactory {
  ...
  private static final int [][] transProb = 
  {
    ...
    //This state doesn't matter, you should never get to it
    /*ADMC  */ {    0,    0,    0,    0,    0,    0,    0, 9877,    0,    0,    0,    0, 9999,    0,    0},
    /*ADMR  */ {    0,    0,    0,    0,    0,    0,    0, 9999,    0,    0,    0,    0,    0,    0,    0},
    /*BESS  */ {    0,    0,    0,    0,    0,    0,    0,  4626,    0,    0,    0,  5297, 9999,    0,  0},

    //This state doesn't matter, you should never get to it
    /*BUYC  */ {    0,    0,    0,    0,    0,    0,    0,   342,    0,    0,    0,    0, 9999,    0,   0},
    /*BUYR  */ {    0,    0,    0,    0, 0,    0,    0,     9999,    0,    0,    0,    0,    0,    0,   0},

    //This state doesn't matter, you should never get to it
    /*CREG  */ {    0,    0,    0,    0,    0, 9145,    0, 9619,    0,    0,    0,    0, 9999,    0,    0},
    /*HOME  */ {    0,    0,    0, 3902,    0,    0,    0,    0, 7805,    0, 8018,    0, 9999,    0,    0},
    /*NEWP  */ {    0,    0,    0,    0,    0,    0,    0,  318,    0,    0,    0, 9895, 9999,    0,    0},
	 /*ORDD  */ {    0,    0,    0,    0,    0,    0,    0,   802,    0,    0,    0,    0, 9999,    0,  0},
	 /*ORDI  */ {    0,    0,    0,    0,    0,    0,    0,   523,    0, 8856,    0,    0, 9999,    0,  0},
    /*PROD  */ {    0,    0,   47,    0,    0,    0,    0,  8382,    0,    0,    0, 9821, 9999,    0,   0},
    /*SREQ  */ {    0,    0,    0,    0,    0,    0,    0,  810,    0,    0,    0,    0,    0, 9999,    0},
    /*SRES  */ {    0,    0,    0,    0,    0,    0,    0, 3693,    0,    0,    0, 9906, 9999,    0,    0},

    //This state doesn't matter, you should never get to it
    /*SHOP  */ {    0,    0,    0,    0,    0,    0, 5215, 9999,    0,    0,    0,    0,    0,    0,    0}
  };
