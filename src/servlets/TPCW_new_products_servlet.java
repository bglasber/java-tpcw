...
public class TPCW_new_products_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    out.print("<H2 ALIGN=\"center\">New Products Page - Subject: " + subject +
              "</H2>\n");
    ...
    Vector books = TPCW_DM.getNewProductsWithinTxn(eb_id, subject);
    ...
    for (i = 0; i < books.size(); i++) {
      ...
      url = "./TPCW_product_detail_servlet?I_ID=" + String.valueOf(book.i_id);
      if (SHOPPING_ID != null)
