...
public class TPCW_buy_request_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
    ...
    if (RETURNING_FLAG.equals("Y")) {
      ...
      cust = TPCW_DM.beginBuyRequestWithCustomer(eb_id, UNAME);
      ...
      cust = TPCW_DM.beginBuyRequestNewCustomer(eb_id, cust);
    } else {
    ...
    Cart mycart =
        TPCW_DM.getCartWithinTxn(eb_id, Integer.parseInt(SHOPPING_ID), cust.c_discount);
    TPCW_DM.commit(eb_id);

    // Print out the web page
    out.print("<HR><FORM ACTION=\"TPCW_buy_confirm_servlet" +
    ...
    out.print(
        "<TR><TD><B>Shipping &amp; Handling</B></TD><TD ALIGN=\"RIGHT\"><B>$" +
    ...
    out.print(
        "<TD><INPUT TYPE=\"RADIO\" NAME=\"SHIPPING\" VALUE=\"AIR\" CHECKED=\"CHECKED\">AIR");
    ...
    out.print("<INPUT TYPE=HIDDEN NAME=\"C_ID\" value = \"" + cust.c_id +
              "\">\n");
    out.print(
        "<INPUT TYPE=\"IMAGE\" NAME=\"Confirm Buy\" SRC=\"../tpcw/Images/submit_B.gif\">\n");
