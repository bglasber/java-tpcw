...
public class TPCW_buy_request_servlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse res)
	  ...
	  cust = TPCW_REST.getCustomer(eb_id, UNAME);
	  TPCW_REST.refreshSession(eb_id, cust.c_id);
	  ...
	  cust = TPCW_REST.createNewCustomer(eb_id, cust);
      }
      ...
      Cart mycart = TPCW_REST.getCart(eb_id, Integer.parseInt(SHOPPING_ID), cust.c_discount);
